...
<!-- 获取系统的数据 -->
<%
	JSONArray allFiles= JSONArray.fromObject(request.getAttribute("fileMsg"));
 %>
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">
                ...
                <div class="span7 personal-info">
                    <form action="createTask.action" method="post">
                        <div class="field-box">
                        <!--任务介绍-->
                            <label>Task Introduction</label>
                            <input name="taskIntroduction" class="span5 inline-input" type="text"/>
                        </div>
                        <div class="field-box">
                        	<label>Task Type:</label>
                            <select name="taskType" id="plan" class="span5">
                            	<option value="文件检索" />文件检索
                            	<option value="重复任务" />重复任务
                            	<option value="重复任务" />数据统计
                            </select>
                        </div>
                        <div class="field-box">
                        	<label>	System File:</label>
                            <select name="systemFileId" id="plan" class="span5">
                             <%
                    			for(int i=0;i<allFiles.size();i++){
                    			JSONObject aFile = JSONObject.fromObject(allFiles.get(i));
                    		 %>
                            	<option value="<%=aFile.get("fileId") %>" /><%=aFile.get("fileName") %>
                        ...
                        <!--文件备份备份次数-->
                            ...
                            <input name="taskParameter" class="span5 inline-input" type="text">
                        </div>
                        <div class="field-box">
                            <label>                                        </label>
                            <button type="submit" class="btn-glow primary login"  >Create Task</button>
                         </div>
                    </form>
                </div>

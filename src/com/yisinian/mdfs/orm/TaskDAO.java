 ...
 * 
 * @see com.yisinian.mdfs.orm.Task
...
public class TaskDAO extends HibernateDaoSupport {
	...
	public static final String NODE_TASK_NUM = "nodeTaskNum";
	...
	public List findByResultPath(Object resultPath) {
		return findByProperty(RESULT_PATH, resultPath);
	}

	public List findByNodeTaskNum(Object nodeTaskNum) {
		return findByProperty(NODE_TASK_NUM, nodeTaskNum);
	}

	public List findByFinishTaskNum(Object finishTaskNum) {
		return findByProperty(FINISH_TASK_NUM, finishTaskNum);
	}

	public List findByFinishRate(Object finishRate) {
		return findByProperty(FINISH_RATE, finishRate);
	}

	public List findByTotalTime(Object totalTime) {
		return findByProperty(TOTAL_TIME, totalTime);
	}
